...
from gear.collections.ssh_collection import ssh
from gear.collections.git_collection import git_add, git_commit, git_dirty
from gear.collections.git_flow_collection import git_flow_release_start, git_flow_release_finish
